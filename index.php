...
class PolaCDK_Control {
    ...
    public static function self_updater() {
        $config = array(
            ...
            'proper_folder_name' => 'pola-cdk-control', // this is the name of the folder your plugin lives in
            'api_url' => 'https://api.github.com/repos/Codeko/pola-cdk-control', // the GitHub API url of your GitHub repo
            'raw_url' => 'https://raw.github.com/Codeko/pola-cdk-control/main', // the GitHub raw url of your GitHub repo
            'github_url' => 'https://github.com/Codeko/pola-cdk-control', // the GitHub url of your GitHub repo
            'zip_url' => 'https://github.com/Codeko/pola-cdk-control/zipball/main', // the zip url of the GitHub repo
